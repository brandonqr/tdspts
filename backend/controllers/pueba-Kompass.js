...
class Pruebas {
    constructor() {
        ...
        this.url = `https://es.kompass.com/easybusiness#/detail/${this.contadorPaginas}/${this.contadorPestanas}`;
        this.jsonFinal = {};
        ...
        this.nightmare
            ...
            .evaluate(() => {
                /*
                  ...
                  var poblacion = direccion_tmp.replace(cp, "").trim();
                  ...
                  $(descripciones).each(function(index) {
                      if (descripciones[index].className == "header with-line") {
                          descripcion[descripciones[index].innerText] = "";
                      } else {
                          descripcion[descripciones[index - 1].innerText] = descripciones[index].innerText;
                      }
                  });
                  jsonFinal = { nombre, telefono, descripcion, cp, poblacion, fuente_id, numeroDePaginas };
                  return jsonFinal;
                  */
                return this.url;
            })
            ...
            .then(objeto => {
                ...
                /*
                  ...
                  //agrgear objeto en jsonFinal(variable global)
